...
//            FirebaseAuth.getInstance().signOut();
    ...
    private void goTomain() {
        startActivity(new Intent(course2.this, MainActivity.class));
    }

    private void goToc1v4() {
        startActivity(new Intent(course2.this, c2v4.class));
    }

    private void goToc1v3() {
        startActivity(new Intent(course2.this, c2v3.class));
    }

    private void goToc1v2() {
        startActivity(new Intent(course2.this, c2v2.class));
    }

    private void goTovc1v1() {
        startActivity(new Intent(course2.this, c2v1.class));
    }
}